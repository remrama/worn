...
class _AddEventDialogState extends State<AddEventDialog> {
  ...
  String? _validateTimes() {
    ...
    if (_includeStop) {
      final stopEarliest =
          _combineDateTime(_stopEarliestDate, _stopEarliestTime);
  ...
  void _submit() {
    ...
    Navigator.pop(
      ...
      AddEventResult(
        ...
        stopEarliest: _includeStop
            ? _combineDateTime(_stopEarliestDate, _stopEarliestTime)
            : null,
        stopLatest: _includeStop
  ...
  Widget _buildDateTimeRow(String label, String dateKey, String timeKey,
      ...
      content: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            _buildDateTimeRow('Earliest', 'startEarliest', 'startEarliest',
                _startEarliestDate, _startEarliestTime),
            _buildDateTimeRow('Latest', 'startLatest', 'startLatest',
                _startLatestDate, _startLatestTime),
            const Divider(),
            CheckboxListTile(
            ...
            if (_includeStop) ...[
              const Text('Stop Time',
                  style: TextStyle(fontWeight: FontWeight.bold)),
              const SizedBox(height: 8),
              _buildDateTimeRow('Earliest', 'stopEarliest', 'stopEarliest',
                  _stopEarliestDate, _stopEarliestTime),
              _buildDateTimeRow('Latest', 'stopLatest', 'stopLatest',
                  _stopLatestDate, _stopLatestTime),
            ],
          ],
        ),
      ),
